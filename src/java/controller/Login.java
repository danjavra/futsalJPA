...
FutsalDAO futsalDAO = new FutsalDAO(); 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       User u = ejb.getEmpleadoByUser(nombreUsuario);
      
       if(ejb.validarEntrada(nombreUsuario, password).isEmpty()){
       ...
       if(nombreUsuario.equalsIgnoreCase("admin")){
           response.sendRedirect(request.getContextPath() + "/pageAdmin.jsp");
       }else{
